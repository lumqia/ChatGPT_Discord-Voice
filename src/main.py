...
async def on_ready():
    ...
    voice_client = discord.utils.get(client.voice_clients, guild=server_ids)
    global vc
...
async def on_message(message: DiscordMessage):
    try:
        ...
        vc.play(discord.FFmpegPCMAudio(executable="C:/ffmpeg/bin/ffmpeg.exe", source="speech.mp3"))
    except Exception as e:
        logger.exception(e)
