# Lumpia's addition
I added function for bot to join specified voice channel (see .env.example). All bot's responses are will be displayed via text and will play the audio in the voice channel.

My goal was to add in a voice recognition to text and have bot respond via speech but, I exceeded the usage amount for free trial.
